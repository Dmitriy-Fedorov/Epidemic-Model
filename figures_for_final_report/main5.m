...
[R0_rnd,R1_rnd,R2_rnd] = calc_R0(NetRnd, alpha, mu, gamma, lambda, kappa, N-number_of_disconnected_nodes);
...
Xuni_ode=Xuni; Xrnd_ode=Xrnd;
tic
[t, Xuni] = ode_yrys(NetUni, [0, RunTime], I1_a_initial_uni, I2_a_initial_uni, N);
toc
tic
[t, Xrnd] = ode_yrys(NetRnd, [0, RunTime], I1_a_initial_rnd, I2_a_initial_rnd, N-number_of_disconnected_nodes);
toc
...
% plot_stch(paramet,uni_,rnd_,N,t,NetUni,NetRnd,false)
% save('Xuni')