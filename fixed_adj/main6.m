...
sub = sprintf('%d_R1r_%g-R2r_%g R1u_%g-R2u_%g',run_id, R1_rnd, R2_rnd, R1_uni, R2_uni);
...
%% Export
strt = sprintf('fig/%s/%d',sub,run_id);
ext = sprintf('%g_%d_%d.xlsx',r, RunTime, monte_rounds);
col_header={'t','Sa','Ss','I1_a','I1_s','I2_a','I2_s'};

xlswrite(sprintf('%s_Stch_uni_%s',strt, ext),uni_','Sheet1','B2')
xlswrite(sprintf('%s_Stch_uni_%s',strt, ext),t,'Sheet1','A2')
xlswrite(sprintf('%s_Stch_uni_%s',strt, ext),col_header,'Sheet1','A1')

xlswrite(sprintf('%s_Stch_rnd_%s',strt, ext),rnd_','Sheet1','B2')
xlswrite(sprintf('%s_Stch_rnd_%s',strt, ext),t,'Sheet1','A2')
xlswrite(sprintf('%s_Stch_rnd_%s',strt, ext),col_header,'Sheet1','A1')

xlswrite(sprintf('%s_Ode_uni_%s',strt, ext),Xuni','Sheet1','B2')
xlswrite(sprintf('%s_Ode_uni_%s',strt, ext),t,'Sheet1','A2')
xlswrite(sprintf('%s_Ode_uni_%s',strt, ext),col_header,'Sheet1','A1')

xlswrite(sprintf('%s_Ode_rnd_%s',strt, ext),Xrnd','Sheet1','B2')
xlswrite(sprintf('%s_Ode_rnd_%s',strt, ext),t,'Sheet1','A2')
xlswrite(sprintf('%s_Ode_rnd_%s',strt, ext),col_header,'Sheet1','A1')

xlswrite(sprintf('%s_Homogen_%s',strt, ext),hmg_sol','Sheet1','B2')
xlswrite(sprintf('%s_Homogen_%s',strt, ext),t,'Sheet1','A2')
xlswrite(sprintf('%s_Homogen_%s',strt, ext),col_header,'Sheet1','A1')

xlswrite(sprintf('%s_Stch_rnd_cil_%s',strt, ext), ci_rnd{1}','Sheet1','B2')
xlswrite(sprintf('%s_Stch_rnd_cil_%s',strt, ext),t,'Sheet1','A2')
xlswrite(sprintf('%s_Stch_rnd_cil_%s',strt, ext),col_header,'Sheet1','A1')

xlswrite(sprintf('%s_Stch_rnd_cih_%s',strt, ext), ci_rnd{2}','Sheet1','B2')
xlswrite(sprintf('%s_Stch_rnd_cih_%s',strt, ext),t,'Sheet1','A2')
xlswrite(sprintf('%s_Stch_rnd_cih_%s',strt, ext),col_header,'Sheet1','A1')

xlswrite(sprintf('%s_Stch_uni_cil_%s',strt, ext), ci_uni{1}','Sheet1','B2')
xlswrite(sprintf('%s_Stch_uni_cil_%s',strt, ext),t,'Sheet1','A2')
xlswrite(sprintf('%s_Stch_uni_cil_%s',strt, ext),col_header,'Sheet1','A1')

xlswrite(sprintf('%s_Stch_uni_cih_%s',strt, ext), ci_uni{2}','Sheet1','B2')
xlswrite(sprintf('%s_Stch_uni_cih_%s',strt, ext),t,'Sheet1','A2')
xlswrite(sprintf('%s_Stch_uni_cih_%s',strt, ext),col_header,'Sheet1','A1')
